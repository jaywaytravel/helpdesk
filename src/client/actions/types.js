...
export const FETCH_COUNT_BY_TYPE = defineAction('FETCH_COUNT_BY_TYPE', [SUCCESS, PENDING, ERROR])

export const FETCH_TOTAL_TICKETS_COUNT = defineAction('FETCH_TOTAL_TICKETS_COUNT', [SUCCESS, PENDING, ERROR])

export const FETCH_TICKET_STATUSES = defineAction('FETCH_TICKET_STATUSES', [SUCCESS, PENDING, ERROR])

export const FETCH_TICKETS_BY_PRIORITY = defineAction('FETCH_TICKETS_BY_PRIORITY', [SUCCESS, PENDING, ERROR])

export const FETCH_AVERAGE_RESOLUTION_TIME = defineAction('FETCH_AVERAGE_RESOLUTION_TIME', [SUCCESS, PENDING, ERROR])
export const FETCH_TICKETS_BY_GROUP = defineAction('FETCH_TICKETS_BY_GROUP', [SUCCESS, PENDING, ERROR])

export const FETCH_TOTAL_TICKETS_LAST_MONTH = defineAction('FETCH_TOTAL_TICKETS_LAST_MONTH', [SUCCESS, PENDING, ERROR])
export const FETCH_CLOSED_OR_REJECTED = defineAction('FETCH_CLOSED_OR_REJECTED', [SUCCESS, PENDING, ERROR])
...
export const FETCH_TICKET_TEMPLATES = defineAction('FETCH_TICKET_TEMPLATES', [SUCCESS, PENDING, ERROR])
