...
export const FETCH_COUNT_BY_TYPE = defineAction('FETCH_COUNT_BY_TYPE', [
  SUCCESS,
  PENDING,
  ERROR
]);

export const FETCH_TOTAL_TICKETS_THIS_MONTH = defineAction('FETCH_TOTAL_TICKETS_THIS_MONTH', [
  SUCCESS,
  PENDING,
  ERROR
]);

export const FETCH_TOTAL_TICKETS_LAST_MONTH = defineAction('FETCH_TOTAL_TICKETS_LAST_MONTH', [
  SUCCESS,
  PENDING,
  ERROR
]);

export const FETCH_CLOSED_OR_REJECTED_LAST_MONTH = defineAction('FETCH_CLOSED_OR_REJECTED_LAST_MONTH', [
  SUCCESS,
  PENDING,
  ERROR
]);

export const FETCH_TICKETS_BY_STATUS_LAST_MONTH = defineAction('FETCH_TICKETS_BY_STATUS_LAST_MONTH', [
  SUCCESS,
  PENDING,
  ERROR
]);

export const FETCH_AVERAGE_RESOLUTION_TIME = defineAction('FETCH_AVERAGE_RESOLUTION_TIME', [
  SUCCESS,
  PENDING,
  ERROR
]);
