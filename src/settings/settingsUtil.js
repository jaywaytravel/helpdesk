  ...
  return new Promise((resolve, reject) => {
    ;(async () => {
      try {
        ...
        s.mailerCheckPolling = parseSetting(settings, 'mailer:check:polling', 60000)
        ...
        s.mailerCheckOAuth2 = parseSetting(settings, 'mailer:check:oauth2', false)
        s.mailerCheckOAuth2ClientId = parseSetting(settings, 'mailer:check:oauthclientid', '')
        s.mailerCheckOAuth2ClientSecret = parseSetting(settings, 'mailer:check:oauthclientsecret', '')
        s.mailerCheckOAuth2RefreshToken = parseSetting(settings, 'mailer:check:oauthrefreshtoken', '')
